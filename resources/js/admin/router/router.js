...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: ROOT_URL + 'event-management',
                name: 'eventManagement',
                component: eventManagement,
                meta: { title: TITLE + ' - event management' }
            },
            {
                path: ROOT_URL + 'professors',
                name: 'professors',
                component: professors,
                meta: { title: TITLE + ' - professors' }
            },
            {
                path: ROOT_URL + 'professor-management',
                name: 'professorManagement',
                component: professorManagement,
                meta: { title: TITLE + ' - professor management' }
            },
            {
                path: ROOT_URL + 'students',
                name: 'students',
                component: students,
                meta: { title: TITLE + ' - students' }
            },
            {
                path: ROOT_URL + 'student-management',
                name: 'studentManagement',
                component: studentManagement,
                meta: { title: TITLE + ' - student management' }
            },
            {
                path: ROOT_URL + 'courses',
                name: 'courses',
                component: courses,
                meta: { title: TITLE + ' - courses' }
            },
            {
                path: ROOT_URL + 'course-management',
                name: 'courseManagement',
                component: courseManagement,
                meta: { title: TITLE + ' - course management' }
            },
            {
                path: ROOT_URL + 'library',
                name: 'library',
                component: library,
                meta: { title: TITLE + ' - library' }
            },
            {
                path: ROOT_URL + 'library-management',
                name: 'libraryManagement',
                component: libraryManagement,
                meta: { title: TITLE + ' - library management' }
            },
            {
                path: ROOT_URL + 'departments',
                name: 'departments',
                component: departments,
                meta: { title: TITLE + ' - departments' }
            },
            {
                path: ROOT_URL + 'department-management',
                name: 'departmentManagement',
                component: departmentManagement,
                meta: { title: TITLE + ' - department management' }
            },
            {
                path: ROOT_URL + 'stuff',
                name: 'stuff',
                component: stuff,
                meta: { title: TITLE + ' - stuff' }
            },
            {
                path: ROOT_URL + 'stuff-management',
                name: 'stuffManagement',
                component: stuffManagement,
                meta: { title: TITLE + ' - stuff management' }
            },
            {
                path: ROOT_URL + 'holiday',
                name: 'holiday',
                component: holiday,
                meta: { title: TITLE + ' - holiday' }
            },
            {
                path: ROOT_URL + 'holiday-management',
                name: 'holidayManagement',
                component: holidayManagement,
                meta: { title: TITLE + ' - holiday management' }
            },
            {
                path: ROOT_URL + 'fees',
                name: 'fees',
                component: fees,
                meta: { title: TITLE + ' - fees' }
            },
            {
                path: ROOT_URL + 'fees-management',
                name: 'feesManagement',
                component: feesManagement,
                meta: { title: TITLE + ' - fees management' }
            },
            {
                path: ROOT_URL + 'profile',
                name: 'profile',
                component: profile,
                meta: { title: TITLE + ' - profile' }
            },
        ]
    },
];
